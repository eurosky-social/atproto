...
const is$typed = _is$typed,
  validate = _validate
const id = 'app.flashes.richtext.facet'

/** Annotation of a sub-string within rich text. */
export interface Main {
  $type?: 'app.flashes.richtext.facet'
  index: ByteSlice
...
export interface Mention {
  $type?: 'app.flashes.richtext.facet#mention'
  did: string
}
...
export interface Link {
  $type?: 'app.flashes.richtext.facet#link'
  uri: string
}
...
export interface Tag {
  $type?: 'app.flashes.richtext.facet#tag'
  tag: string
}
...
export interface ByteSlice {
  $type?: 'app.flashes.richtext.facet#byteSlice'
  byteStart: number
  byteEnd: number
}

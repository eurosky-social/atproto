...
const is$typed = _is$typed,
  validate = _validate
const id = 'app.flashes.unspecced.defs'

export interface SkeletonSearchPost {
  $type?: 'app.flashes.unspecced.defs#skeletonSearchPost'
  uri: string
}
...
export interface SkeletonSearchActor {
  $type?: 'app.flashes.unspecced.defs#skeletonSearchActor'
  did: string
}
...
export interface SkeletonSearchStarterPack {
  $type?: 'app.flashes.unspecced.defs#skeletonSearchStarterPack'
  uri: string
}
...
export interface TrendingTopic {
  $type?: 'app.flashes.unspecced.defs#trendingTopic'
  topic: string
  displayName?: string
  description?: string
  link: string
...
export interface SkeletonTrend {
  $type?: 'app.flashes.unspecced.defs#skeletonTrend'
  topic: string
  displayName: string
  link: string
  startedAt: string
...
export interface TrendView {
  $type?: 'app.flashes.unspecced.defs#trendView'
  topic: string
  displayName: string
  link: string
  startedAt: string
  ...
  status?: 'hot' | (string & {})
  category?: string
  actors: AppFlashesActorDefs.ProfileViewBasic[]
}
...
export interface ThreadItemPost {
  $type?: 'app.flashes.unspecced.defs#threadItemPost'
  post: AppFlashesFeedDefs.PostView
...
export interface ThreadItemNoUnauthenticated {
  $type?: 'app.flashes.unspecced.defs#threadItemNoUnauthenticated'
}
...
export interface ThreadItemNotFound {
  $type?: 'app.flashes.unspecced.defs#threadItemNotFound'
}
...
export interface ThreadItemBlocked {
  $type?: 'app.flashes.unspecced.defs#threadItemBlocked'
...
export interface AgeAssuranceState {
  $type?: 'app.flashes.unspecced.defs#ageAssuranceState'
...
export interface AgeAssuranceEvent {
  $type?: 'app.flashes.unspecced.defs#ageAssuranceEvent'

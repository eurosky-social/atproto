...
const is$typed = _is$typed,
  validate = _validate
const id = 'app.flashes.notification.defs'

export interface RecordDeleted {
  $type?: 'app.flashes.notification.defs#recordDeleted'
}
...
export interface ChatPreference {
  $type?: 'app.flashes.notification.defs#chatPreference'
...
export interface FilterablePreference {
  $type?: 'app.flashes.notification.defs#filterablePreference'
...
export interface Preference {
  $type?: 'app.flashes.notification.defs#preference'
  list: boolean
  push: boolean
}
...
export interface Preferences {
  $type?: 'app.flashes.notification.defs#preferences'
  chat: ChatPreference
...
export interface ActivitySubscription {
  $type?: 'app.flashes.notification.defs#activitySubscription'
  post: boolean
  reply: boolean
}
...
export interface SubjectActivitySubscription {
  $type?: 'app.flashes.notification.defs#subjectActivitySubscription'
  subject: string

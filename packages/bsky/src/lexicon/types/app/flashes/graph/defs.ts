...
const is$typed = _is$typed,
  validate = _validate
const id = 'app.flashes.graph.defs'

export interface ListViewBasic {
  $type?: 'app.flashes.graph.defs#listViewBasic'
  uri: string
  cid: string
  name: string
  purpose: ListPurpose
...
export interface ListView {
  $type?: 'app.flashes.graph.defs#listView'
  uri: string
  cid: string
...
export interface ListItemView {
  $type?: 'app.flashes.graph.defs#listItemView'
  uri: string
  subject: AppFlashesActorDefs.ProfileView
}
...
export interface StarterPackView {
  $type?: 'app.flashes.graph.defs#starterPackView'
  uri: string
  cid: string
  record: { [_ in string]: unknown }
  creator: AppFlashesActorDefs.ProfileViewBasic
  list?: ListViewBasic
  listItemsSample?: ListItemView[]
  feeds?: AppFlashesFeedDefs.GeneratorView[]
...
export interface StarterPackViewBasic {
  $type?: 'app.flashes.graph.defs#starterPackViewBasic'
  uri: string
  cid: string
  record: { [_ in string]: unknown }
  creator: AppFlashesActorDefs.ProfileViewBasic
...
export interface ListViewerState {
  $type?: 'app.flashes.graph.defs#listViewerState'
  muted?: boolean
  blocked?: string
}
...
export interface NotFoundActor {
  $type?: 'app.flashes.graph.defs#notFoundActor'
  actor: string
  notFound: true
}
...
export interface Relationship {
  $type?: 'app.flashes.graph.defs#relationship'
  did: string

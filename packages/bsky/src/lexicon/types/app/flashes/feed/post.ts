...
const is$typed = _is$typed,
  validate = _validate
const id = 'app.flashes.feed.post'
...
export interface Record {
  ...
  facets?: AppFlashesRichtextFacet.Main[]
  reply?: ReplyRef
  embed?:
    | $Typed<AppFlashesEmbedImages.Main>
    | $Typed<AppFlashesEmbedVideo.Main>
    | $Typed<AppFlashesEmbedExternal.Main>
    | $Typed<AppFlashesEmbedRecord.Main>
    | $Typed<AppFlashesEmbedRecordWithMedia.Main>
    | { $type: string }
...
export interface ReplyRef {
  $type?: 'app.flashes.feed.post#replyRef'
...
export interface Entity {
  $type?: 'app.flashes.feed.post#entity'
  index: TextSlice
...
export interface TextSlice {
  $type?: 'app.flashes.feed.post#textSlice'
  start: number
  end: number
}

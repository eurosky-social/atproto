...
import type * as AppFlashesEmbedImages from '../embed/images.js'
import type * as AppFlashesEmbedVideo from '../embed/video.js'
import type * as AppFlashesEmbedExternal from '../embed/external.js'
import type * as AppFlashesEmbedRecord from '../embed/record.js'
import type * as AppFlashesEmbedRecordWithMedia from '../embed/recordWithMedia.js'
...
const is$typed = _is$typed,
  validate = _validate
const id = 'app.flashes.feed.defs'

export interface PostView {
  $type?: 'app.flashes.feed.defs#postView'
  uri: string
  cid: string
  ...
  embed?:
    ...
    | $Typed<AppFlashesEmbedRecord.View>
...
export interface ViewerState {
  $type?: 'app.flashes.feed.defs#viewerState'
  repost?: string
  like?: string
  bookmarked?: boolean
  threadMuted?: boolean
...
export interface ThreadContext {
  $type?: 'app.flashes.feed.defs#threadContext'
...
export interface FeedViewPost {
  $type?: 'app.flashes.feed.defs#feedViewPost'
  post: PostView
  reply?: ReplyRef
...
export interface ReplyRef {
  $type?: 'app.flashes.feed.defs#replyRef'
  root:
    | $Typed<PostView>
    | $Typed<NotFoundPost>
    | $Typed<BlockedPost>
  ...
  parent:
    ...
    | $Typed<BlockedPost>
    | { $type: string }
  grandparentAuthor?: AppFlashesActorDefs.ProfileViewBasic
}
...
export interface ReasonRepost {
  $type?: 'app.flashes.feed.defs#reasonRepost'
  by: AppFlashesActorDefs.ProfileViewBasic
  uri?: string
  cid?: string
  indexedAt: string
}
...
export interface ReasonPin {
  $type?: 'app.flashes.feed.defs#reasonPin'
}
...
export interface ThreadViewPost {
  $type?: 'app.flashes.feed.defs#threadViewPost'
  post: PostView
  parent?:
...
export interface NotFoundPost {
  $type?: 'app.flashes.feed.defs#notFoundPost'
  uri: string
  notFound: true
}
...
export interface BlockedPost {
  $type?: 'app.flashes.feed.defs#blockedPost'
  uri: string
  blocked: true
...
export interface BlockedAuthor {
  $type?: 'app.flashes.feed.defs#blockedAuthor'
  did: string
  viewer?: AppFlashesActorDefs.ViewerState
}
...
export interface GeneratorView {
  $type?: 'app.flashes.feed.defs#generatorView'
  uri: string
  cid: string
  did: string
  creator: AppFlashesActorDefs.ProfileView
  displayName: string
  description?: string
...
export interface GeneratorViewerState {
  $type?: 'app.flashes.feed.defs#generatorViewerState'
  like?: string
}
...
export interface SkeletonFeedPost {
  $type?: 'app.flashes.feed.defs#skeletonFeedPost'
  post: string
  reason?:
...
export interface SkeletonReasonRepost {
  $type?: 'app.flashes.feed.defs#skeletonReasonRepost'
  repost: string
}
...
export interface SkeletonReasonPin {
  $type?: 'app.flashes.feed.defs#skeletonReasonPin'
}
...
export interface ThreadgateView {
  $type?: 'app.flashes.feed.defs#threadgateView'
  uri?: string
  cid?: string
  record?: { [_ in string]: unknown }
  lists?: AppFlashesGraphDefs.ListViewBasic[]
}
...
export interface Interaction {
  $type?: 'app.flashes.feed.defs#interaction'
  item?: string
  event?:

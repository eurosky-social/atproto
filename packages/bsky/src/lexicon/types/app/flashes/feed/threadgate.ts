...
const is$typed = _is$typed,
  validate = _validate
const id = 'app.flashes.feed.threadgate'

export interface Record {
  $type: 'app.flashes.feed.threadgate'
...
export interface MentionRule {
  $type?: 'app.flashes.feed.threadgate#mentionRule'
}
...
export interface FollowerRule {
  $type?: 'app.flashes.feed.threadgate#followerRule'
}
...
export interface FollowingRule {
  $type?: 'app.flashes.feed.threadgate#followingRule'
}
...
export interface ListRule {
  $type?: 'app.flashes.feed.threadgate#listRule'
  list: string
}

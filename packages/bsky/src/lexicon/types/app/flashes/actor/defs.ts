...
import type * as AppFlashesNotificationDefs from '../notification/defs.js'
import type * as AppFlashesFeedThreadgate from '../feed/threadgate.js'
import type * as AppFlashesFeedPostgate from '../feed/postgate.js'
import type * as AppFlashesEmbedExternal from '../embed/external.js'

const is$typed = _is$typed,
  validate = _validate
const id = 'app.flashes.actor.defs'

export interface ProfileViewBasic {
  $type?: 'app.flashes.actor.defs#profileViewBasic'
  did: string
  handle: string
  displayName?: string
  pronouns?: string
...
export interface ProfileView {
  $type?: 'app.flashes.actor.defs#profileView'
  did: string
  handle: string
  displayName?: string
  pronouns?: string
...
export interface ProfileViewDetailed {
  $type?: 'app.flashes.actor.defs#profileViewDetailed'
  did: string
  handle: string
  displayName?: string
  description?: string
  ...
  postsCount?: number
  associated?: ProfileAssociated
  joinedViaStarterPack?: AppFlashesGraphDefs.StarterPackViewBasic
  indexedAt?: string
  createdAt?: string
  viewer?: ViewerState
  labels?: ComAtprotoLabelDefs.Label[]
...
export interface ProfileAssociated {
  $type?: 'app.flashes.actor.defs#profileAssociated'
  lists?: number
  feedgens?: number
  starterPacks?: number
  labeler?: boolean
...
export interface ProfileAssociatedChat {
  $type?: 'app.flashes.actor.defs#profileAssociatedChat'
...
export interface ProfileAssociatedActivitySubscription {
  $type?: 'app.flashes.actor.defs#profileAssociatedActivitySubscription'
...
export interface ViewerState {
  $type?: 'app.flashes.actor.defs#viewerState'
  muted?: boolean
  mutedByList?: AppFlashesGraphDefs.ListViewBasic
  blockedBy?: boolean
  blocking?: string
  blockingByList?: AppFlashesGraphDefs.ListViewBasic
  following?: string
  followedBy?: string
...
export interface KnownFollowers {
  $type?: 'app.flashes.actor.defs#knownFollowers'
  count: number
...
export interface VerificationState {
  $type?: 'app.flashes.actor.defs#verificationState'
...
export interface VerificationView {
  $type?: 'app.flashes.actor.defs#verificationView'
...
export interface AdultContentPref {
  $type?: 'app.flashes.actor.defs#adultContentPref'
  enabled: boolean
}
...
export interface ContentLabelPref {
  $type?: 'app.flashes.actor.defs#contentLabelPref'
...
export interface SavedFeed {
  $type?: 'app.flashes.actor.defs#savedFeed'
  id: string
...
export interface SavedFeedsPrefV2 {
  $type?: 'app.flashes.actor.defs#savedFeedsPrefV2'
  items: SavedFeed[]
}
...
export interface SavedFeedsPref {
  $type?: 'app.flashes.actor.defs#savedFeedsPref'
  pinned: string[]
  saved: string[]
...
export interface PersonalDetailsPref {
  $type?: 'app.flashes.actor.defs#personalDetailsPref'
...
export interface FeedViewPref {
  $type?: 'app.flashes.actor.defs#feedViewPref'
...
export interface ThreadViewPref {
  $type?: 'app.flashes.actor.defs#threadViewPref'
...
export interface InterestsPref {
  $type?: 'app.flashes.actor.defs#interestsPref'
...
export interface MutedWord {
  $type?: 'app.flashes.actor.defs#mutedWord'
  id?: string
...
export interface MutedWordsPref {
  $type?: 'app.flashes.actor.defs#mutedWordsPref'
...
export interface HiddenPostsPref {
  $type?: 'app.flashes.actor.defs#hiddenPostsPref'
...
export interface LabelersPref {
  $type?: 'app.flashes.actor.defs#labelersPref'
...
export interface LabelerPrefItem {
  $type?: 'app.flashes.actor.defs#labelerPrefItem'
  did: string
}
...
export interface BskyAppStatePref {
  $type?: 'app.flashes.actor.defs#bskyAppStatePref'
...
export interface BskyAppProgressGuide {
  $type?: 'app.flashes.actor.defs#bskyAppProgressGuide'
  guide: string
}
...
export interface Nux {
  $type?: 'app.flashes.actor.defs#nux'
  id: string
  completed: boolean
...
export interface VerificationPrefs {
  $type?: 'app.flashes.actor.defs#verificationPrefs'
...
export interface PostInteractionSettingsPref {
  $type?: 'app.flashes.actor.defs#postInteractionSettingsPref'
  /** Matches threadgate record. List of rules defining who can reply to this users posts. If value is an empty array, no one can reply. If value is undefined, anyone can reply. */
  threadgateAllowRules?: (
    | $Typed<AppFlashesFeedThreadgate.MentionRule>
    | $Typed<AppFlashesFeedThreadgate.FollowerRule>
    | $Typed<AppFlashesFeedThreadgate.FollowingRule>
    | $Typed<AppFlashesFeedThreadgate.ListRule>
    | { $type: string }
  )[]
  /** Matches postgate record. List of rules defining who can embed this users posts. If value is an empty array or is undefined, no particular rules apply and anyone can embed. */
  postgateEmbeddingRules?: (
    | $Typed<AppFlashesFeedPostgate.DisableRule>
    | { $type: string }
  )[]
}
...
export interface StatusView {
  $type?: 'app.flashes.actor.defs#statusView'
  /** The status for the account. */
  status: 'app.flashes.actor.status#live' | (string & {})
  record: { [_ in string]: unknown }
  embed?: $Typed<AppFlashesEmbedExternal.View> | { $type: string }

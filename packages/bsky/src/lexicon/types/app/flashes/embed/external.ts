...
const is$typed = _is$typed,
  validate = _validate
const id = 'app.flashes.embed.external'

/** A representation of some externally linked content (eg, a URL and 'card'), embedded in a Bluesky record (eg, a post). */
export interface Main {
  $type?: 'app.flashes.embed.external'
  external: External
}
...
export interface External {
  $type?: 'app.flashes.embed.external#external'
  uri: string
  title: string
  description: string
  thumb?: BlobRef
...
export interface View {
  $type?: 'app.flashes.embed.external#view'
...
export interface ViewExternal {
  $type?: 'app.flashes.embed.external#viewExternal'
  uri: string
  title: string
  description: string
  thumb?: string

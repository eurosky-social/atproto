...
import type * as AppFlashesEmbedDefs from './defs.js'

const is$typed = _is$typed,
  validate = _validate
const id = 'app.flashes.embed.images'

export interface Main {
  $type?: 'app.flashes.embed.images'
  images: Image[]
}
...
export interface Image {
  $type?: 'app.flashes.embed.images#image'
  image: BlobRef
  /** Alt text description of the image, for accessibility. */
  alt: string
  aspectRatio?: AppFlashesEmbedDefs.AspectRatio
}
...
export interface View {
  $type?: 'app.flashes.embed.images#view'
  images: ViewImage[]
}
...
export interface ViewImage {
  $type?: 'app.flashes.embed.images#viewImage'

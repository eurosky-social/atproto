...
const is$typed = _is$typed,
  validate = _validate
const id = 'app.flashes.labeler.defs'

export interface LabelerView {
  $type?: 'app.flashes.labeler.defs#labelerView'
  uri: string
  cid: string
...
export interface LabelerViewDetailed {
  $type?: 'app.flashes.labeler.defs#labelerViewDetailed'
  uri: string
  cid: string
  creator: AppFlashesActorDefs.ProfileView
...
export interface LabelerViewerState {
  $type?: 'app.flashes.labeler.defs#labelerViewerState'
  like?: string
}
...
export interface LabelerPolicies {
  $type?: 'app.flashes.labeler.defs#labelerPolicies'
